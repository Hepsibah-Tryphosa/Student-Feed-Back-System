...
String query1 = "select ratingvalue from library3 where qid=?";
String update ="update library3 set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from library3 where qid=?";
String updateCount ="update library3 set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Library3.jsp?msg=success");
