...
String query1 = "select ratingvalue from political where qid=?";
String update ="update political set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from political where qid=?";
String updateCount ="update political set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Political.jsp?msg=success");
