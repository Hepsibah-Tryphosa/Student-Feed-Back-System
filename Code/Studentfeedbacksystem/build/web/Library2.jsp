...
Sincerely, <b style="color: #333399" >Library  </b> Team Manager
</p><br/>
<br/>
<form action="Library2Feedback.jsp" method="post">
<div class="CSSTableGenerator" >
  ...
  <table>
    ...
    <tr>
                ...
                <tr>
                    <td>1</td>
                    <td>Overall, I am very satisfied with the way Library  team performed on this Occasions</td>
                ...
                <tr>
                    <td>2</td>
                    <td>Compared to how you felt about Library  team before their performance</td>
      ...
      <tr>
                    <td>3</td>
                    <td>The Athletic Department wants to know what you think about Library  team playing experience</td>
                ...
                <tr>
                    <td>4</td>
                    <td>How did your perform on Library  team</td>
      ...
      <tr>
                    <td>7</td>
                    <td>Have you ever contacted Library  Administrative</td>
                ...
                <tr>
                    <td>8</td>
                    <td>If you contacted Library  Administrative, have all problems been resolved to your complete satisfaction?</td>
      ...
      <tr>
                    <td>9</td>
                    <td>Based on your awareness of Library  team,is it better, the same, or worse than other Library  teams</td>
                ...
                <tr>
                    <td>10</td>
                    <td>Based on your experience with Library  team, would you recommend this game to a friend</td>
...
ResultSet rs = null;
String query1 = "select count from library2 where qid=?";
String query2 = "select sum(ratingvalue) from library2";
int sumofRating=0;
...
%>    
<br/>
<h2>Total FeedBack Percentage of The Library   is: <b style="color: #333399" ><%=totalFeedBack%> &nbsp;%</b> </h2>
<br/><br/>
<form action="SubmitFeedBack.jsp" method="post">
    <table class="CSSTableGenerator">
        <tr>
            <td>Topic Name</td>
            <td><input style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 800px;height: 30px;font-weight: bolder;font-size: 17px" type="text" readonly="" name="topicname" value="Library"/></td>
        </tr>
