...
Sincerely, <b style="color: #333399" >College of Education </b> Team Manager
</p><br/>
<br/>
<form action="OrganizationFeedback.jsp" method="post">
<div class="CSSTableGenerator" >
  ...
  <table>
    ...
    <tr>
                ...
                <tr>
                    <td>1</td>
                    <td>Overall, I am very satisfied with the way College of Education team performed on this Occasions</td>
                ...
                <tr>
                    <td>2</td>
                    <td>Compared to how you felt about College of Education team before their performance</td>
      ...
      <tr>
                    <td>3</td>
                    <td>The Athletic Department wants to know what you think about College of Education team playing experience</td>
                ...
                <tr>
                    <td>4</td>
                    <td>How did your perform on Organization team</td>
      ...
      <tr>
                    <td>7</td>
                    <td>Have you ever contacted College of Education Administrative</td>
                ...
                <tr>
                    <td>8</td>
                    <td>If you contacted College of Education Administrative, have all problems been resolved to your complete satisfaction?</td>
      ...
      <tr>
                    <td>9</td>
                    <td>Based on your awareness of College of Education team,is it better, the same, or worse than other College of Education teams</td>
                ...
                <tr>
                    <td>10</td>
                    <td>Based on your experience with College Of Education team, would you recommend this game to a friend</td>
...
ResultSet rs = null;
String query1 = "select count from organization where qid=?";
String query2 = "select sum(ratingvalue) from organization";
int sumofRating=0;
...
%>    
<br/>
<h2>Total FeedBack Percentage of The College Of Education is: <b style="color: #333399" ><%=totalFeedBack%> &nbsp;%</b> </h2>
<br/><br/>
<form action="SubmitFeedBack.jsp" method="post">
    <table class="CSSTableGenerator">
        <tr>
            <td>Topic Name</td>
            <td><input style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 800px;height: 30px;font-weight: bolder;font-size: 17px" type="text" readonly="" name="topicname" value="College of Education"/></td>
        </tr>
