...
Sincerely, <b style="color: #333399" >Faculties 1 </b> Team Manager
</p><br/>
<br/>
<form action="Faculties1Feedback.jsp" method="post">
...
ResultSet rs = null;
String query1 = "select count from faculties1 where qid=?";
String query2 = "select sum(ratingvalue) from faculties1";
int sumofRating=0;
...
%>    
<br/>
<h2>Total FeedBack Percentage of The Faculties 1  is: <b style="color: #333399" ><%=totalFeedBack%> &nbsp;%</b> </h2>
<br/><br/>
<form action="SubmitFeedBack.jsp" method="post">
    <table class="CSSTableGenerator">
        <tr>
            <td>Topic Name</td>
            <td><input style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 800px;height: 30px;font-weight: bolder;font-size: 17px" type="text" readonly="" name="topicname" value="Faculties1"/></td>
        </tr>
