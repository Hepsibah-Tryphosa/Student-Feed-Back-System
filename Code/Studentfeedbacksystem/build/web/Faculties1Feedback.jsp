...
String query1 = "select ratingvalue from faculties1 where qid=?";
String update ="update faculties1 set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from faculties1 where qid=?";
String updateCount ="update faculties1 set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Faculties1.jsp?msg=success");
