...
String query1 = "select ratingvalue from dinner where qid=?";
String update ="update dinner set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from dinner where qid=?";
String updateCount ="update dinner set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Dinner.jsp?msg=success");
