...
Sincerely, <b style="color: #333399" >BasketBall </b> Team Manager
</p><br/>
<br/>
<form action="BasketBallFeedback.jsp" method="post">
<div class="CSSTableGenerator" >
  ...
  <table>
    ...
    <tr>
                ...
                <tr>
                    <td>1</td>
                    <td>Overall, I am very satisfied with the way BasketBall team performed on this Occasions</td>
                ...
                <tr>
                    <td>2</td>
                    <td>Compared to how you felt about BasketBall team before their performance</td>
      ...
      <tr>
                    <td>3</td>
                    <td>The Athletic Department wants to know what you think about BasketBall team playing experience</td>
                ...
                <tr>
                    <td>4</td>
                    <td>How did your perform on BasketBall team</td>
      ...
      <tr>
                    <td>7</td>
                    <td>Have you ever contacted BasketBall Administrative</td>
                ...
                <tr>
                    <td>8</td>
                    <td>If you contacted BasketBall Administrative, have all problems been resolved to your complete satisfaction?</td>
      ...
      <tr>
                    <td>9</td>
                    <td>Based on your awareness of BasketBall team,is it better, the same, or worse than other BasketBall teams</td>
                ...
                <tr>
                    <td>10</td>
                    <td>Based on your experience with BasketBall team, would you recommend this game to a friend</td>
...
ResultSet rs = null;
String query1 = "select count from basketball where qid=?";
String query2 = "select sum(ratingvalue) from basketball";
int sumofRating=0;
...
%>    
<br/>
<h2>Total FeedBack Percentage of The BasketBall Game is: <b style="color: #333399" ><%=totalFeedBack%> &nbsp;%</b> </h2>
<br/><br/>
<form action="SubmitFeedBack.jsp" method="post">
    <table class="CSSTableGenerator">
        <tr>
            <td>Topic Name</td>
            <td><input style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 800px;height: 30px;font-weight: bolder;font-size: 17px" type="text" readonly="" name="topicname" value="BasketBall"/></td>
        </tr>
