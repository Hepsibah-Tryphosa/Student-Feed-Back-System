...
Sincerely, <b style="color: #333399" >Faculties 4 </b> Team Manager
</p><br/>
<br/>
<form action="Faculties4Feedback.jsp" method="post">
<div class="CSSTableGenerator" >
  ...
  <table>
    ...
    <tr>
                ...
                <tr>
                    <td>1</td>
                    <td>Overall, I am very satisfied with the way Faculties 4 team performed on this Occasions</td>
                ...
                <tr>
                    <td>2</td>
                    <td>Compared to how you felt about Faculties 4 team before their performance</td>
      ...
      <tr>
                    <td>3</td>
                    <td>The Athletic Department wants to know what you think about Faculties 4 team playing experience</td>
                ...
                <tr>
                    <td>4</td>
                    <td>How did your perform on Faculties 4 team</td>
      ...
      <tr>
                    <td>7</td>
                    <td>Have you ever contacted Faculties 4 Administrative</td>
                ...
                <tr>
                    <td>8</td>
                    <td>If you contacted Faculties 4 Administrative, have all problems been resolved to your complete satisfaction?</td>
      ...
      <tr>
                    <td>9</td>
                    <td>Based on your awareness of Faculties 4 team,is it better, the same, or worse than other Faculties 4 teams</td>
                ...
                <tr>
                    <td>10</td>
                    <td>Based on your experience with Faculties 4 team, would you recommend this game to a friend</td>
...
%>    
<br/>
<h2>Total FeedBack Percentage of The Faculties 4 is: <b style="color: #333399" ><%=totalFeedBack%> &nbsp;%</b> </h2>
<br/><br/>
<form action="SubmitFeedBack.jsp" method="post">
    <table class="CSSTableGenerator">
        <tr>
            <td>Topic Name</td>
            <td><input style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 800px;height: 30px;font-weight: bolder;font-size: 17px" type="text" readonly="" name="topicname" value="Faculties4"/></td>
        </tr>
