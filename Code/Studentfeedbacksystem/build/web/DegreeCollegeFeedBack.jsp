...
String query1 = "select ratingvalue from DegreeCollege where qid=?";
String update ="update DegreeCollege set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from DegreeCollege where qid=?";
String updateCount ="update DegreeCollege set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("DegreeCollege.jsp?msg=success");
