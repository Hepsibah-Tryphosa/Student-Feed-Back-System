...
String query1 = "select ratingvalue from faculties4 where qid=?";
String update ="update faculties4 set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from Faculties4 where qid=?";
String updateCount ="update Faculties4 set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Faculties4.jsp?msg=success");
