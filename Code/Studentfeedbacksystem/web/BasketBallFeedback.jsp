...
String query1 = "select ratingvalue from basketball where qid=?";
String update ="update basketball set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from basketball where qid=?";
String updateCount ="update basketball set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("BasketBall.jsp?msg=success");
