...
String query1 = "select ratingvalue from baseball where qid=?";
String update ="update baseball set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from baseball where qid=?";
String updateCount ="update baseball set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("BaseBall.jsp?msg=success");
