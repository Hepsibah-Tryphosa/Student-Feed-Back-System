...
String query1 = "select ratingvalue from faculties3 where qid=?";
String update ="update faculties3 set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from Faculties3 where qid=?";
String updateCount ="update Faculties3 set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Faculties3.jsp?msg=success");
