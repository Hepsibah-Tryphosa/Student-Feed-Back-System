...
String query1 = "select ratingvalue from breakfast where qid=?";
String update ="update breakfast set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from breakfast where qid=?";
String updateCount ="update breakfast set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("BreakFast.jsp?msg=success");
