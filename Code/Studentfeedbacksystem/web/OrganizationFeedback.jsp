...
String query1 = "select ratingvalue from organization where qid=?";
String update ="update organization set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from organization where qid=?";
String updateCount ="update organization set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Organisation.jsp?msg=success");
