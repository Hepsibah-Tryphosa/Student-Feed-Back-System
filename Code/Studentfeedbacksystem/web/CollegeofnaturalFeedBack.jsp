...
String query1 = "select ratingvalue from collegeofnatural where qid=?";
String update ="update collegeofnatural set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from collegeofnatural where qid=?";
String updateCount ="update collegeofnatural set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("CollegeofNatural.jsp?msg=success");
