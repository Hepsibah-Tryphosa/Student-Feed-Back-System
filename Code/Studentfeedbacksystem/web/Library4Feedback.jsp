...
String query1 = "select ratingvalue from library4 where qid=?";
String update ="update library4 set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from library4 where qid=?";
String updateCount ="update library4 set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Library4.jsp?msg=success");
