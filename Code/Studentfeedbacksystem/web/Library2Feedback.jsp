...
String query1 = "select ratingvalue from library2 where qid=?";
String update ="update library2 set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from library2 where qid=?";
String updateCount ="update library2 set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Library2.jsp?msg=success");
