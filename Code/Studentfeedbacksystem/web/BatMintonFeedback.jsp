...
String query1 = "select ratingvalue from batminton where qid=?";
String update ="update batminton set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from batminton where qid=?";
String updateCount ="update batminton set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("BatMinton.jsp?msg=success");
