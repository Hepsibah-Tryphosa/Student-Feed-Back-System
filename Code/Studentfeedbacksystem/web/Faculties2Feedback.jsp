...
String query1 = "select ratingvalue from faculties2 where qid=?";
String update ="update faculties2 set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from faculties2 where qid=?";
String updateCount ="update faculties2 set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Faculties2.jsp?msg=success");
