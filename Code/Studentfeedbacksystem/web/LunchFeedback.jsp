...
String query1 = "select ratingvalue from lunch where qid=?";
String update ="update lunch set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from lunch where qid=?";
String updateCount ="update lunch set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Lunch.jsp?msg=success");
