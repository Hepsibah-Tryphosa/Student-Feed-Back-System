...
String query1 = "select ratingvalue from grill where qid=?";
String update ="update grill set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from grill where qid=?";
String updateCount ="update grill set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Grill.jsp?msg=success");
