...
String query1 = "select ratingvalue from mihaylocollege where qid=?";
String update ="update mihaylocollege set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from mihaylocollege where qid=?";
String updateCount ="update mihaylocollege set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("MihayloCollege.jsp?msg=success");
