...
String query1 = "select ratingvalue from community where qid=?";
String update ="update community set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from community where qid=?";
String updateCount ="update community set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("Community.jsp?msg=success");
