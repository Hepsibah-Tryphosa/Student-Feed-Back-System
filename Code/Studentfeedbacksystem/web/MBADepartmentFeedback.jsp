...
String query1 = "select ratingvalue from mbadepart where qid=?";
String update ="update mbadepart set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from mbadepart where qid=?";
String updateCount ="update mbadepart set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("MBADepart.jsp?msg=success");
