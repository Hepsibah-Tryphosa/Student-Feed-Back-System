...
String query1 = "select ratingvalue from football where qid=?";
String update ="update football set ratingvalue=? where qid=?";
Connection con=null;
...
String queryCount = "select count from football where qid=?";
String updateCount ="update football set count=? where qid=?";
...
ps1.executeUpdate();
response.sendRedirect("FootBall.jsp?msg=success");
